export default {
  ...
  toProjectsLink: "Zu den Projekten",
  ...
  nowPlaying: "Gerade höre ich",
  notPlaying: "Nichts läuft gerade",

  mediakitTitle: "Media Kit",
  mediakitFonts: "Schriftarten",
  mediakitColors: "Farben",
  ...
  projectsTeaser: "Ein Blick auf meine aktuellen Arbeiten.",

  searchPlaceholder: "Projekte suchen...",
  filterAll: "Alle",
  filterMore: "mehr Filter",
  ...
  socialTitle: "Social",
  socialIntro: "Meine letzten Beiträge – direkt von meinem eigenen Server.",
  socialViewProfile: "Vollständiges Profil anzeigen",
  socialEmpty: "Noch keine Beiträge.",
  socialError: "Der Feed konnte gerade nicht geladen werden.",
  socialAlsoOn: "Weitere Accounts",
};
