...
import { getCvSecretByValue, getCvFileData, getCvFile, CV_COOKIE, CV_LANGS, type CvLang } from '../../../lib/db';
...
export const GET: APIRoute = ({ cookies, url }) => {
  ...
  const lang: CvLang = (CV_LANGS as readonly string[]).includes(rawLang) ? (rawLang as CvLang) : 'de';
