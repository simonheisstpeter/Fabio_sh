...
export default function Navigation () {
  ...
  const setMobileMenu = (themeSelected) => {
                ...
                <div className={ menuOpen ? "hidden" : "visible h-screen pt-44"}>
                    <div className="grid grid-cols-1 text-2xl" onClick={() => toggleMenu()}>
                      ...
                      */}
                      ...
                      <button className={theme === 'dark' ? "hover:text-emerald-600" : "hidden"} onClick={() => { toggleMenu(); setTheme('light'); }}>
                        ...
                        <button className={theme === 'light' ? "hover:text-emerald-600" : "hidden"} onClick={() => { toggleMenu(); setTheme('dark'); }}>
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" id="moon" className="mb-6 text-emerald-400 mx-auto h-8 w-8"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
                        </button>  
                    </div>
                </div>
            </nav>
