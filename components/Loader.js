  ...
  return (
    <div className="mr-7 inline-block">
      <span
        ...
        } before:content after:content relative mx-auto block before:absolute before:inset-0 before:rounded-full before:bg-gray-300 before:duration-200 after:absolute after:inset-0 after:z-[1] after:rounded-full after:border-[1px] after:border-loaderBorder after:bg-loaderAlpha after:backdrop-blur-[10px] hover:before:bg-emerald-400`}
      ></span>
    </div>
  );
};
