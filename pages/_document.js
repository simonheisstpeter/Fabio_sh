    ...
    return (
      <Html>
        <Head>
          ...
          <meta property="og:title" content="Fabio Gschweidl" />
          <meta property="og:image" content="/meta_pic.png" />
          <meta
            property="og:description"
            content="Webdeveloper Webdevelopment Webdesign Wireframe Consulting Wireframe Consulting Wireframe"
          />
        ...
        <body className="dotsDark cursor-fabiosh">
          <Main />
          <NextScript />
        </body>
