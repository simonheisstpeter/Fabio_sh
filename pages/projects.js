    ...
    <>
      <Container>
        <div className="container mx-auto h-full px-4 md:px-12">
          <h1 className="my-20 text-xl font-andesNeueBold">{t.menuProjects}</h1>

          <h2 className="mb-6 font-andesNeueExtraLight">{t.currentProjects}</h2>
          ...
          <h2 className="mb-6 font-andesNeueExtraLight">{t.upcomingProjects}</h2>
          ...
          <h2 className="mb-6 font-andesNeueExtraLight">{t.finishedProjects}</h2>
          <article className="mb-20 grid grid-cols-1 gap-6 opacity-50 duration-200 hover:opacity-100 lg:grid-cols-3 xl:grid-cols-5">
