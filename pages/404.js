...
export default function Custom404() {
  ...
  return (
    <section className="h-screen w-full">
      ...
      <Link href="/">
        <a className="block text-center w-32 mt-12 bg-gradient-to-br hover:from-emerald-300 hover:to-emerald-500 border-emerald-600 border-2 px-4 py-2 rounded-lg duration-300 mx-auto text-white">
          {t.custom404Button}
        </a>
      </Link>
    </section>
